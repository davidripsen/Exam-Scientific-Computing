...
\emph{Author:}\\
\lareg David Ribberholt Ipsen (s164522)\\
\end{center}
\end{minipage}\\[4cm]
...
\postdate{\vfill\hfill\emph{\small Collaborators: Liv B. Skovhus (s184028), Freja M.P. Petersen (s184321), Luca Bertolani (s220647)}\hfill}
\end{titlepage}
